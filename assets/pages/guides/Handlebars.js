...
const Handlebars = ({ navigation }) => {
  const openYouTubeLink = () => {
    Linking.openURL('https://youtu.be/RGvfTMY7LTI?si=5SB0jEj9l7HReOU9');
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity onPress={openYouTubeLink}>
        <Image source={require('../../img/handlebars1.png')} style={styles.image} />
      </TouchableOpacity>
      ...
      <View style={styles.toolsAndMaterials}>
        ...
        <Text style={styles.toolItem}>- Screwdriver (if needed)</Text>
      </View>
